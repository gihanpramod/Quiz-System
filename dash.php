    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Create Quiz<span class="caret"></span></a>
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%; color:red;font-size:30px;"><b>Details About Quiz</b></span><br /><br />
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;color:red; font-size:30px;"><b>Create Your Questions</b></span><br /><br />
...
';
 ...
 for($i=1;$i<=@$_GET['n'];$i++)
 {
echo '<b style=color:red;>Question number&nbsp;'.$i.'&nbsp;:</><br /><!-- Text input-->
<div class="form-group">
...
<br />
<b style=color:red;>Correct answer</b>:<br />
